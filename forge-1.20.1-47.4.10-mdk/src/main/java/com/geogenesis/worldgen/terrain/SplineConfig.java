...
public record SplineConfig(
    ...
    public static SplineConfig defaults() {
        return new SplineConfig(
            ...
            // PLAIN inner spline (12): lo=[0.015,0.015], hi=[0.06,0.06]
            0.0, 0.015, 0.0, 1.0, 0.015, 0.0,
            0.0, 0.06,  0.0, 1.0, 0.06,  0.0,
            // HILLS inner spline (12): lo=[0.06,0.06], hi=[0.25,0.25]
            0.0, 0.06,  0.0, 1.0, 0.06,  0.0,
            ...
            // PLATEAU inner spline (12): lo=[0.20,0.20], hi=[0.45,0.45]
            0.0, 0.20,  0.0, 1.0, 0.20,  0.0,
            0.0, 0.45,  0.0, 1.0, 0.45,  0.0,
            // BASIN inner spline (12): lo=[0.015,0.015], hi=[0.08,0.08]
            0.0, 0.015, 0.0, 1.0, 0.015, 0.0,
