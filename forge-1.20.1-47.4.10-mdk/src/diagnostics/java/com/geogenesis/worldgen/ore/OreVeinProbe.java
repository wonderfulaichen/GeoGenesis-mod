...
public final class OreVeinProbe {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //   ★ 2026-09-18 M2 更新：区间由 [140,330] 改为基于**当前基线 384.1** 的 ±40%。
        //     改动原因：M2 逐矿种标定（coal 1.00→2.20）+ 地质校正（IRON 宿主岩由"全 8 种"
        //     收窄为 BIF/沉积 4 种、COPPER 补入 GRANITE 母岩）后，总量 231.9 → 384.1，
        //     旧上限 330 已被合理改动突破 ⇒ 不更新会让"正确结果"报 FAIL。
        //   ★ 判据7 的定位：只挡"手滑改成 10 倍/0.1 倍"，**不**充当精确平衡门禁
        //     （精确分布由判据7b 与 OreOverrideProbe 分担）。
        double lo7 = 384.1 * 0.6, hi7 = 384.1 * 1.4;
